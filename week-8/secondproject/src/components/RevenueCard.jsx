...
export const RevenueCard = ({title,orderCount,amount})=>{
    ...
    return <div className="bg-white rounded   p-9  shadow-md">
        <div className="flex  text-gray-700 text-sm	font-light">
              <div className="">{title} 
...
<div className="underline cursor-pointer font-bold text-blue    ">
